...
$pageScripts = ['js/validaciones.js', 'js/admin.js'];
...
<div class="container my-5">
    <div class="mx-auto" style="max-width: 500px;">
        ...
        <h1 class="mb-4 text-center " id="titulo-form">Acceso Administrador</h1>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="input-group">
                            ...
                            <input type="text" id="inputUsuario" name="usuario" class="form-control" placeholder="Ingresa correo institucional" autocomplete="username" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="input-group">
                            ...
                            Su contraseña debe incluir mínimo 6 caracteres, una mayúscula, un dígito y un carácter especial.                
                    </div>
                        </div>
                    </div>
